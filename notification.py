...
def send_email(name, email,content,title):
	print(f'Name: {name}\nEmail:{email}\ncontent: {content}\ntitle: {title}')
	# Email settings
	sender_email = 'chandalurisnigdha@gmail.com' # sender email address
	sender_password = 'kkel xxkg fuse vrrf' # sender email password
...
print(f"✅ Notification server started and listening on port {port}...")
